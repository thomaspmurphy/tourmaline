...
describe('ThreadList', () => {
  ...
  it('renders empty state when no threads', () => {
    ...
    expect(screen.getByText('No threads yet. Be the first to start a discussion!')).toBeInTheDocument()
  })
  ...
  it('renders error state', () => {
    ...
    expect(screen.getByText('Error: Failed to load threads')).toBeInTheDocument()
  })
